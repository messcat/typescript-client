const BASE_PATH = "https://api.messcat.ai/payments".replace(/\/+$/, "");
...
export const RecurringCreditConsumptionType = {
    ...
    PrepurchasedCallChannel: 'prepurchased_call_channel'
} as const;
...
export const CreditsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        autoRenewalCancel: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["PAYMENTS_UPDATE"], configuration)
        ...
        creditGainsGet: async (customerId?: string, count?: number, cursor?: string, type?: Array<CreditGainType>, createdAt?: DateRange, status?: CreditGainStatus, returnTotal?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["PAYMENTS_READ"], configuration)
...
export const ReferralsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        partnerReferralsDelete: async (referralCode: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["PARTNER_ADMIN_PANEL_ACCESS", "ADMIN_PANEL_ACCESS"], configuration)
...
export const SubscriptionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        subscriptionsPatch: async (id: string, subscriptionUpdate?: SubscriptionUpdate, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["PAYMENTS_UPDATE", "PARTNER_ADMIN_PANEL_ACCESS"], configuration)
