const BASE_PATH = "https://api.messcat.ai/auth".replace(/\/+$/, "");
...
/**
 * A refresh token allows you to generate access tokens to access & update things on services. A refresh token will expire and become invalidated after 14 days of no activity. 
 * @export
...
export interface Team {
    ...
    /**
     * The team will be the admin team of a partner if this property is not null.
     * @type {string}
     * @memberof Team
     */
    'partnerAdmin'?: string | null;
...
export const InviteLinksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        inviteLinksPost: async (eitherRoleOrScopes?: EitherRoleOrScopes, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["TEAMLINK_CREATE"], configuration)
...
export const OAuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        tokenDelete: async (token?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["TOKENS_DELETE"], configuration)
        ...
        tokenGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["TOKENS_READ"], configuration)
...
export const SubUserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        subUserDelete: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["TEAMMEMBERS_UPDATE"], configuration)
        ...
        subUserLogout: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["LOGOUT_SUB_USER"], configuration)
        ...
        subUserPost: async (subUserCreate?: SubUserCreate, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["CREATE_SUB_USER"], configuration)
...
export const TeamsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        teamsPatch: async (teamPatchRequest?: TeamPatchRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["TEAM_UPDATE"], configuration)
...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        usersPatch: async (userId?: string, userPatch?: UserPatch, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["USERS_PATCH"], configuration)
...
export const WidgetConfigApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        widgetPatch: async (optionalWidgetConfigParams?: OptionalWidgetConfigParams, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication token required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "token", ["WIDGET_EDIT"], configuration)
